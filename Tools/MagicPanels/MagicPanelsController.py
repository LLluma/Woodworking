    ...
    try:
        ...
        for o in objects:
            ...
            if objRef.isDerivedFrom("Part::Cone"):
                R1, R2, H = (
                    objRef.Radius1.Value,
                    objRef.Radius2.Value,
                    objRef.Height.Value,
                )
