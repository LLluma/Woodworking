...
def setRouterPattern(iSketch, iBitSizes, iType):
    if iType == "Cove" or iType == "Cove2" or iType == "Cove4":
        ...
        iSketch.addGeometry(
            Part.Circle(
                FreeCAD.Vector(-11.104589, 7.436932, 0),
    ...
    if iType == "RoundOver" or iType == "RoundOver2" or iType == "RoundOver4":
        ...
        iSketch.addGeometry(
            Part.ArcOfCircle(
                Part.Circle(
                    FreeCAD.Vector(17.964924, -14.676168, 0),
                    FreeCAD.Vector(0, 0, 1),
                    15.909641,
                ),
                1.709506,
        ...
        iSketch.addGeometry(
            Part.ArcOfCircle(
                Part.Circle(
                    FreeCAD.Vector(-19.469606, 18.381221, 0),
                    FreeCAD.Vector(0, 0, 1),
                    16.402145,
                ),
                4.613597,
        ...
        iSketch.addGeometry(
            Part.ArcOfCircle(
                Part.Circle(
                    FreeCAD.Vector(17.204672, 18.981390, 0),
                    FreeCAD.Vector(0, 0, 1),
                    13.708001,
                ),
                3.258160,
        ...
        iSketch.addGeometry(
            Part.ArcOfCircle(
                Part.Circle(
                    FreeCAD.Vector(-18.880601, -19.950044, 0),
                    FreeCAD.Vector(0, 0, 1),
                    16.185459,
                ),
                0.050111,
    ...
    if iType == "Straight2" or iType == "Straight3" or iType == "Straight4":
        ...
        iSketch.addGeometry(
            Part.LineSegment(
                FreeCAD.Vector(-13.867397, 19.250723, 0),
                FreeCAD.Vector(26.556583, 18.528873, 0),
            ),
            False,
        )
        ...
        iSketch.addGeometry(
            Part.LineSegment(
                FreeCAD.Vector(26.556583, 19.250723, 0),
                FreeCAD.Vector(25.834734, -12.150050, 0),
            ),
            False,
        )
        ...
        iSketch.addGeometry(
            Part.LineSegment(
                FreeCAD.Vector(26.556583, -12.150050, 0),
                FreeCAD.Vector(-12.784623, -20.812334, 0),
            ),
            False,
        )
        iSketch.addConstraint(Sketcher.Constraint("Coincident", 1, 2, 2, 1))
        iSketch.addGeometry(
            Part.LineSegment(
                FreeCAD.Vector(-12.784623, -20.812334, 0),
                FreeCAD.Vector(-14.228333, 17.807013, 0),
            ),
            False,
        )
    ...
    if iType == "Chamfer" or iType == "Chamfer2" or iType == "Chamfer4":
        ...
        ProfileLib.RegularPolygon.makeRegularPolygon(
            iSketch,
            4,
            FreeCAD.Vector(-5.108387, 13.778920, 0),
            FreeCAD.Vector(-3.000101, -11.358306, 0),
            False,
        )
