...
try:
    ...
    for o in objects:
        ...
        for d in cylinders:
            ...
            if o.Shape.BoundBox.isInside(v1) or o.Shape.BoundBox.isInside(v2) or o.Shape.BoundBox.isInside(v3):
                tocut.append(d)
