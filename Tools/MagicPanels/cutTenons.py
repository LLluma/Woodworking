...
try:
    ...
    for o in objects:
        ...
        for tenon in tenons:
            ...
            if (
                o.Shape.BoundBox.isInside(v1)
                or o.Shape.BoundBox.isInside(v2)
                or o.Shape.BoundBox.isInside(v3)
                or o.Shape.BoundBox.isInside(v4)
                or o.Shape.BoundBox.isInside(v5)
                or o.Shape.BoundBox.isInside(v6)
            ):
                tocut.append(tenon)
