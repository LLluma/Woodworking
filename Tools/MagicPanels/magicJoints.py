...
def showQtGUI():
    class QtMainClass(QtGui.QDialog):
        ...
        def showJoints(self):
            ...
            X, Y, Z = (
                self.gAnchorCurrent[0],
                self.gAnchorCurrent[1],
                self.gAnchorCurrent[2],
            )
            x, y, z = 0, 0, 0
        ...
        def setMortise(self):
            try:
                ...
                [self.gObj2, self.gObj2Face] = MagicPanels.makeMortise(
                    self.gLink, self.gDepth, self.gObj2, self.gObj2Face
                )
                self.gObj2FaceIndex = MagicPanels.getFaceIndex(self.gObj2, self.gObj2Face)
        ...
        def setTenon(self):
            try:
                ...
                [self.gObj2, self.gObj2Face] = MagicPanels.makeTenon(
                    self.gLink, self.gDepth, self.gObj2, self.gObj2Face
                )
                self.gObj2FaceIndex = MagicPanels.getFaceIndex(self.gObj2, self.gObj2Face)
        ...
        def setJoints(self):
            try:
                ...
                [self.gObj3, self.gObj3Face] = MagicPanels.makeMortise(
                    self.gLink, self.gDepth, self.gObj3, self.gObj3Face
                )
                self.gObj3FaceIndex = MagicPanels.getFaceIndex(self.gObj3, self.gObj3Face)
