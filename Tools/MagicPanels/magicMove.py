...
def showQtGUI():
    class QtMainClass(QtGui.QDialog):
        ...
        def initUI(self):
            ...
            self.sModeList = ("Move", "Copy", "Copy Path", "Mirror")
            ...
            self.sCopyTypeList = ("copyObject", "Clone", "Link")
        ...
        def setLastPosition(self):
            for o in self.gObjects:
                ...
                [
                    ...
                    self.gLCPZ[key],
                    self.gLCPR[key],
                ] = MagicPanels.getContainerPlacement(toMove, "clean")
        ...
        def createCopy(self, iType):
            ...
            for o in self.gObjects:
                ...
                [
                    ...
                    self.gLCPZ[key],
                    self.gLCPR[key],
                ] = MagicPanels.getContainerPlacement(copy, "clean")
