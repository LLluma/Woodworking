...
try:
    ...
    if len(objects) < 1:
        ...
        info += translate(
            "showAlias",
            "<b>The preview mode has been deactivated. You can turn it on again at any time. </b><br><br>",
        )
        ...
        if objects[0].isDerivedFrom("Spreadsheet::Sheet"):
            ...
            info += translate(
                "showAlias",
                "<b>The preview mode has been activated. Select spreadsheet cell with alias to see objects. </b><br><br>",
            )
            MagicPanels.showInfo("showAlias", info)
