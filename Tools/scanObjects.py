...
def showQtGUI():
    class QtMainClass(QtGui.QDialog):
        ...
        def setWindowsColors(self, selectedText):
            ...
            if (
                selectedText == "my world is gray"
                or selectedText == "beautiful pinky world"
                or selectedText == "the Sun is free?"
                or selectedText == "the sky is blue"
                or selectedText == "grass is green everywhere"
                or selectedText == "I like winter more"
            ):
        ...
        def goDeeper(self, iObj, iLabel, iList, iType):
            ...
            if len(tmpO) > 0 and len(tmpL) > 0:
                ...
                if self.gModeType == "matrix":
                    self.showMsg(
                        "This is the end of the rabbit hole. Go back quickly before you get lost ;-)",
                        "info",
                    )
                else:
                    self.showMsg(
                        "Can't parse this object structure deeper. Check deeper at the python console.",
                        "info",
                    )
