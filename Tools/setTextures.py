    ...
    class QtMainClass(QtGui.QDialog):
        ...
        def storeTextures(self, iSearch, iSelect):
            ...
            for obj in iSearch:
                ...
                if (
                    iSelect != "selected"
                    and not obj.isDerivedFrom("Part::Box")
                    and not obj.isDerivedFrom("Part::Cylinder")
                    and not obj.isDerivedFrom("Part::Sphere")
                    and not obj.isDerivedFrom("PartDesign::Pad")
                ):
                    continue
