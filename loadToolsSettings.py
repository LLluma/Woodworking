...
Tools = [
    ...
    (
        ...
        "magicCNC",
        "png",
        "magicCNC, drill bit move machine",
    ...
    (
        ...
        "png",
        "drillReport",
        "Calculate intersections between panel and dowels and reports drill coorditantes",
    ),
    # preview
    ...
    (
        ...
        "magicResizer",
        "png",
        "magicResizer, smart resizer tool",
